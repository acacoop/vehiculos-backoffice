    ...
    return (
      <div className="user-car-panel-container">
        <div className="table-header">
          <h2 className="table-header-title">Vehículos Asignados</h2>
        </div>
  ...
  return (
    <div className="user-car-panel-container">
      <Table<Assignment>
        ...
        onAddButtonClick={() => navigate(`/assignment/create?userId=${userId}`)}
        maxWidth="1200px"
        containerClassName="user-car-panel-container"
      />
    </div>
  );
}
